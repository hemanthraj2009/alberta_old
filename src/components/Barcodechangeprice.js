...
import {Platform, StyleSheet, Text, View,TouchableOpacity,Image,Keyboard,
  TextInput,AsyncStorage,Dimensions,Vibration,ScrollView,Alert} from 'react-native';
...
export default class Barcodechangeprice extends Component {
     ...
     AsyncStorage.getItem('token').then((data) => {
        ...
        fetch(`https://portal.albertapayments.com/api/admin/checkPriceBySKU_new?sku=${this.state.barcode}&token=${encodeURIComponent(data)}&sid=${SID}`, {
            ...
            .then((responseJson) => {
             ...
             else if (responseJson.error == 'No Barcode Found') {
