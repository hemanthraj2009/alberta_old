...
export default class NoSale extends Component {
  constructor(props) {
    ...
    this.setState({ DELETE_NOTIFICATION: null });
  }
      ...
      if (data) {
        ...
        return fetch(API_URL)
          ...
          .then(responseJson => {
            ...
            this.setState({ DELETE_NOTIFICATION: responseJson.delete });
          })
          .catch(error => {
  ...
  render() {
    ...
    // if(!this.state.DELETE_NOTIFICATION)
      ...
      <ScrollView>
        ...
        <View style={css.home_screen.v_container}>
          <FlatList
            ...
            data={this.state.DELETE_NOTIFICATION}
